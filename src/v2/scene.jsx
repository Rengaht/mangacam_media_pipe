...
const Cube = ({ video, canvas, mask, bg, state: sceneState, width, height, opacity }) => {
    const mesh = useRef();
    ...
    useFrame((state) => {
        ...
        //     mesh.current.material.uniforms.u_bg.value=bgTexture;
        // }
        // if(mesh.current.material.uniforms.u_bg.value!=null){
